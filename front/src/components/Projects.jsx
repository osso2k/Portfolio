  ...
  return (
    <div className='max-w-[90%] mx-auto grid grid-cols-1 gap-1 sm:gap-2 md:gap-3 md:grid-cols-2 lg:grid-cols-3 mt-10 '>
        <motion.div initial={{y:30 , opacity:0}} animate={{y:0 , opacity:1}} transition={{ease:"easeInOut" , duration:2}} className='bg-[hsl(0,0%,6%)] px-2 py-4 rounded-lg '>
          ...
          <h2 className='text-md text-gray-300 mt-2'>Time management tool</h2>
        ...
        <motion.div initial={{y:30 , opacity:0}} animate={{y:0 , opacity:1}} transition={{ease:"easeInOut" , duration:6}} className='bg-[hsl(0,0%,6%)] px-2 py-4 rounded-lg '>
          <div className='flex justify-between mb-5 border-b border-zinc-800 mx-5'>
          <h1 className='italic text-xl md:text-2xl pr-2 font-semibold '>JPrep </h1> <span className='cursor-pointer hover:opacity-55 text-md  px-4 py-1 h-fit mb-2 bg-zinc-800 border border-black bg-opacity-35 text-zinc-600 rounded' onClick={()=>{window.open("https://github.com/osso2k/JobPrep", "_blank")}}> source</span>
          </div>
          <img src={jprep} alt="" className=' rounded-lg w-fit object-contain border border-black ' />
          <h2 className='text-md text-gray-300 mt-2'>Interview preparation platform</h2>
